...
namespace Inventory
{
	...
	static const UINT64 TradeWindowOffset_OurItems = 0x6C0;
	static const UINT64 TradeWindowOffset_TheirItems = TradeWindowOffset_OurItems - 8;
...
{
public:
	std::list<Inventory::Item*> GetTradeWindowItems(int inventorySide);
};
