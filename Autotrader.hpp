#pragma once
#define TABS_LOGGED 6 //should be 4 by default
...
//todo make a class instead of using statics
struct Trade
{
	bool IsInTrade;
	...
	std::wstring TradingPlayerName; //shared for buy and sell as both wont happen at once
