...
namespace CurrencyFilePaths
{
	...
	const std::wstring EnkindlingOrb = L"Metadata/Items/Currency/CurrencyEnkindlingOrb";
	const std::wstring InstillingOrb = L"Metadata/Items/Currency/CurrencyInstillingOrb";
	const std::wstring EngineerOrb = L"Metadata/Items/Currency/CurrencyStrongboxQualityShard";
